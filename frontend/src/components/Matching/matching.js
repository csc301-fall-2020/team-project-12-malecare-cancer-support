...
<div class="col h-100">
      <div class="row top no-gutters menuContainer">
        <div class="col-3 navigation bigRightBorder"><img class="menuIcon" src={menuIcon} /></div>
        <div class="col">
          <div class="row logoAndMode">
            <div class="col-7 logo">CancerChat</div>
            <div class="col-1"></div>
            <div class="col-1"><img class="mentorIcon" src={mentorIcon} /></div>
            <div class="col-1"><img class="heartIcon" src={heartIcon} /></div>
            <div class="col-2"></div>
          </div>
        </div>
      </div>
